...
The possible log destinations are `stdout`, `stderr`, `file`, `syslog`, `logcat` and `dynamic`.
...
Chronicles will log to "stdout" by default on all platforms except Android. Use this define to specify a different default choice.
